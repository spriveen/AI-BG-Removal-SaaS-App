    ...
    {/* Image Caontainer */}
       <div className='flex flex-col sm:grid grid-cols-2 gap-8'>
        ...
        <div>
          ...
          <img className='rounded-md boarder' src={assets.image_w_bg} alt=''/>
        </div>

        {/* Right side */}
        <div className='flex flex-col'>
          <p  className='font-semibold text-gray-600 mb-2'>Background Removed</p>
          <div className='rounded-md boarder boarder-gray-300 h-full relative bg-layer overflow-hiodden'>
       ...
       {/* Buttons */}
       <div className='flex jusitify-center sm:justify-end items-center flex-wrap gap-4 mt-6'>
